...
<body>
    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown active"><a href="about.php" style="color: #62cfea;"><span>About</span> <i class="bx bx-chevron-down"></i></a>
            <ul>
              <li><a href="about.php">About</a></li>
              <li><a class="active" style="color: #62cfea;" href="visi-misi.php">Vision & Mission</a></li>
  ...
  <!------------------- Visi Misi ------------------------>
    <div class="container container-fluid pt-5 pb-5">
        <div class="card mb-3">
        <h2 class="card-title text-center mt-2">Vision & Mission</h2>
